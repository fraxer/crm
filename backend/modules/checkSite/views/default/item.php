...
<div class="item">
    <div class="data">
        ...
        <div class="column column_actions">
            ...
            <a href="<?= Url::toRoute(['update', 'id' => $model->id]) ?>" class="link" title="<?= Yii::t('item', 'update') ?>">
                <svg width="17px" height="17px" viewBox="0 0 20 20">
                    <path d="M12.3 3.7l4 4L4 20H0v-4L12.3 3.7zm1.4-1.4L16 0l4 4-2.3 2.3-4-4z"/>
                </svg>
            </a>
            <a href="<?= Url::toRoute(['delete', 'id' => $model->id]) ?>" data-confirm="<?= Yii::t('item', !count($model->childs) ? 'confirm_delete_domain' : 'confirm_delete_section') ?>" data-method="post" class="link" title="<?= Yii::t('item', 'delete') ?>">
            ...
            <div class="dropdown" onclick="<?= $isSection ? 'toggleSection(event)' : 'toggleDomain(event)' ?>" title="<?= Yii::t('item', 'toggle') ?>">
